...
def create_all_tables(db_manager):
    ...
    db_manager.create_table(
        ...
        """(
            ...
            client_username VARCHAR(255) NOT NULL UNIQUE,
            client_password VARCHAR(255) NOT NULL,
            client_ip VARCHAR(255),
            client_port INT,
            client_last_active VARCHAR(255),
            client_ddos_status BOOLEAN DEFAULT FALSE
        )"""
    )
    ...
    db_manager.create_table(
        ...
        """(
            ...
            file_result_path VARCHAR(255),
            file_orig_size VARCHAR(255),
            file_new_size VARCHAR(255)
        )"""
    )
